...
DocMeta.setdocmeta!(ESMLiteratureCompare, :DocTestSetup, :(using ESMLiteratureCompare); recursive = true)
...
makedocs(;
    modules = [ESMLiteratureCompare],
    authors = "Uwe Hernandez Acosta <u.hernandez@hzdr.de>",
    repo = "https://github.com/JuliaXRTS/ESMLiteratureCompare.jl/blob/{commit}{path}#{line}",
    sitename = "ESMLiteratureCompare.jl",
    format = Documenter.HTML(; canonical = "https://JuliaXRTS.github.io/ESMLiteratureCompare.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/JuliaXRTS/ESMLiteratureCompare.jl")
